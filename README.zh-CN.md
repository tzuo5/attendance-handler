...
<p align="center">
  ...
  <a href="https://github.com/tzuo5/attendance-handler/releases/tag/v0.1.0"><img src="https://img.shields.io/github/v/release/tzuo5/attendance-handler?display_name=tag&style=flat-square&color=0f766e" alt="最新版本" /></a>
...
需要 macOS、Apple Command Line Tools、Node.js 22.12+ 和位于 `/Applications` 的 Google Chrome。
...
npm run dist:mac            # 在 release-public/ 生成通用 DMG + ZIP
```
...
更多已验证行为和限制见[验证记录](VERIFICATION.md)及 [v0.1.0 Release 说明](docs/RELEASE-v0.1.0.md)。
